...
class user(Base):
    ...
    draw_time = Column(Integer, unique=False, nullable=False, comment='draw_time')
    ...
    def __repr__(self):
        return f'{self.id}&{self.create_time}&{self.dyid}&{self.updated_at}&{self.draw_time}&{self.lottery_info_type}'
